...
namespace KursProject.Controllers
{
    public class SpecialitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SpecialityID,Name,KafedraID")] Speciality speciality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SpecialityID,Name,KafedraID")] Speciality speciality)
        {
            if (ModelState.IsValid)
            {
